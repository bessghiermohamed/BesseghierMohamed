(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,31278,e=>{"use strict";let t=(0,e.i(75254).default)("loader-circle",[["path",{d:"M21 12a9 9 0 1 1-6.219-8.56",key:"13zald"}]]);e.s(["Loader2",()=>t],31278)},68509,e=>{"use strict";var t=e.i(43476),i=e.i(71645),s=e.i(46932),a=e.i(88653),d=e.i(78583),r=e.i(40160);let o=(0,e.i(75254).default)("eye",[["path",{d:"M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0",key:"1nclc0"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);var l=e.i(31278),n=e.i(95468),c=e.i(10980),p=e.i(69638),g=e.i(3116),x=e.i(14683),v=e.i(58377),m=e.i(32095),h=e.i(27225),b=e.i(26154),u=e.i(15288),f=e.i(19455);function y(e){return e>=92?"A+":e>=85?"A":e>=75?"B+":e>=65?"B":e>=55?"C+":e>=40?"C":e>=20?"D":"F"}function k(e){return({"A+":4,A:3.75,"B+":3.5,B:3,"C+":2.5,C:2,D:1,F:0})[e]??0}function w(e,t){let i=t.find(t=>t.subjectId===e);return i?{status:i.status,progress:i.progress}:{status:"not_started",progress:0}}let j={not_started:"لم تبدأ",in_progress:"قيد التقدم",completed:"مكتملة"},C={hidden:{opacity:0},visible:{opacity:1,transition:{staggerChildren:.06}}},F={hidden:{opacity:0,y:12},visible:{opacity:1,y:0,transition:{duration:.4,ease:"easeOut"}}};function N(){let{progress:e,subjectNotes:N,studySessions:$}=(0,h.useAppStore)(),[B,D]=(0,i.useState)(!1),[A,z]=(0,i.useState)(!1),[S,M]=(0,i.useState)(!1),P=(0,i.useMemo)(()=>{let t=b.subjectsData.length,i=e.filter(e=>"completed"===e.status).length,s=e.filter(e=>"in_progress"===e.status).length,a=t>0?e.reduce((e,t)=>e+t.progress,0)/t:0;return{total:t,completed:i,inProgress:s,notStarted:t-i-s,overallProgress:a}},[e]),T=(0,i.useMemo)(()=>b.categories.map(t=>{let i=b.subjectsData.filter(e=>e.category===t.id),s=i.length,a=s>0?i.reduce((t,i)=>t+w(i.id,e).progress,0)/s:0;return{...t,total:s,avgProgress:Math.round(a)}}),[e]),E=(0,i.useMemo)(()=>({1:b.subjectsData.filter(e=>1===e.semester).sort((e,t)=>e.order-t.order),2:b.subjectsData.filter(e=>2===e.semester).sort((e,t)=>e.order-t.order)}),[]),O=(0,i.useMemo)(()=>{let t=t=>{let i=0,s=0;return t.forEach(t=>{let a=y(w(t.id,e).progress);i+=k(a),s++}),s>0?Math.round(i/s*100)/100:0};return{sem1:t(E[1]),sem2:t(E[2])}},[e,E]),H=(0,i.useMemo)(()=>(function(e){let t=e.filter(e=>e.completed).map(e=>new Date(e.date).toISOString().split("T")[0]).filter((e,t,i)=>i.indexOf(e)===t).sort().reverse();if(0===t.length)return{currentStreak:0,bestStreak:0};let i=new Date().toISOString().split("T")[0],s=new Date(Date.now()-864e5).toISOString().split("T")[0],a=0;if(t[0]===i||t[0]===s){a=1;for(let e=1;e<t.length;e++){let i=new Date(t[e-1]),s=new Date(t[e]);if(.5>Math.abs((i.getTime()-s.getTime())/864e5-1))a++;else break}}let d=1,r=1;for(let e=1;e<t.length;e++){let i=new Date(t[e-1]),s=new Date(t[e]);.5>Math.abs((i.getTime()-s.getTime())/864e5-1)?d=Math.max(d,++r):r=1}return{currentStreak:a,bestStreak:d}})($),[$]),_=(0,i.useCallback)(()=>{let t,i,s,a=new Date,d=a.toLocaleDateString("ar-DZ",{year:"numeric",month:"long",day:"numeric"}),r=a.toLocaleTimeString("ar-DZ",{hour:"2-digit",minute:"2-digit"}),o=t=>{let i=w(t.id,e),s=y(i.progress),a=N[t.id]||"",d=b.categories.find(e=>e.id===t.category)?.color||"#B91C1C",r="completed"===i.status?"#16A34A":"in_progress"===i.status?"#D97706":"#9CA3AF";return`
        <tr>
          ...
          <td style="padding:8px 12px;border-bottom:1px solid #eee;text-align:center;direction:ltr;">${k(s).toFixed(2)}</td>
        </tr>
      ...
      `},l=(t=[...E[1],...E[2]],i=0,s=0,t.forEach(t=>{let a=w(t.id,e);i+=k(y(a.progress)),s++}),s>0?Math.round(i/s*100)/100:0),n=l>=3?"#16A34A":l>=2?"#D97706":"#B91C1C";return`<!DOCTYPE html>
...
<body>
  ...
  <div class="section no-page-break">
    ...
    <div class="stats-grid">
      <div class="stat-card">
        <div class="stat-value" style="color:#B91C1C;">${P.total}</div>
        <div class="stat-label">إجمالي المواد</div>
      </div>
      <div class="stat-card">
        <div class="stat-value" style="color:#16A34A;">${P.completed}</div>
        <div class="stat-label">مكتملة</div>
      </div>
      <div class="stat-card">
        <div class="stat-value" style="color:#D97706;">${P.inProgress}</div>
        <div class="stat-label">قيد التقدم</div>
      </div>
      <div class="stat-card">
        <div class="stat-value" style="color:#9CA3AF;">${P.notStarted}</div>
        <div class="stat-label">لم تبدأ</div>
      </div>
    </div>
    <div style="text-align:center;margin-top:16px;">
      <div style="font-size:48px;font-weight:900;color:#B91C1C;" dir="ltr">${Math.round(P.overallProgress)}%</div>
...
</html>`},[e,N,$,P,T,E,O,H]),G=(0,i.useCallback)(async()=>{D(!0);try{await new Promise(e=>setTimeout(e,600));let e=_(),t=window.open("","_blank");t&&(t.document.write(e),t.document.close(),t.onload=()=>{setTimeout(()=>{t.print()},500)}),M(!0),setTimeout(()=>M(!1),3e3)}finally{D(!1)}},[_]),I=(0,i.useCallback)(()=>{let e=_(),t=window.open("","_blank");t&&(t.document.write(e),t.document.close())},[_]),L=(0,i.useMemo)(()=>({s1Completed:E[1].filter(t=>"completed"===w(t.id,e).status).length,s2Completed:E[2].filter(t=>"completed"===w(t.id,e).status).length}),[e,E]);return(0,t.jsx)(s.motion.div,{variants:C,initial:"hidden",animate:"visible",children:(0,t.jsxs)(u.Card,{className:"glass card-ornament overflow-hidden border-border",children:[(0,t.jsx)(u.CardHeader,{className:"pb-3",children:(0,t.jsxs)(u.CardTitle,{className:"text-base font-semibold flex items-center gap-2",children:[(0,t.jsx)(d.FileText,{className:"size-5 text-omni-red"}),"تقرير التقدم الدراسي"]})}),(0,t.jsxs)(u.CardContent,{className:"space-y-4",children:[(0,t.jsx)("p",{className:"text-sm text-muted-foreground",children:"أنشئ تقريراً شاملاً لتقدمك الأكاديمي بصيغة PDF جاهز للطباعة"}),(0,t.jsx)(s.motion.div,{variants:F,children:(0,t.jsx)("button",{onClick:()=>z(!A),className:"w-full text-right",children:(0,t.jsxs)("div",{className:"rounded-xl border border-border p-4 bg-gradient-to-br from-omni-red/5 via-background to-omni-gold/5 hover:from-omni-red/10 hover:to-omni-gold/10 transition-all duration-300",children:[(0,t.jsxs)("div",{className:"flex items-center justify-between mb-3",children:[(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[(0,t.jsx)("div",{className:"w-8 h-8 rounded-lg bg-omni-red/10 flex items-center justify-center",children:(0,t.jsx)(m.GraduationCap,{className:"size-4 text-omni-red"})}),(0,t.jsx)("span",{className:"text-sm font-semibold",children:"معاينة التقرير"})]}),(0,t.jsx)(o,{className:"size-4 text-muted-foreground"})]}),(0,t.jsxs)("div",{className:"grid grid-cols-4 gap-2",children:[(0,t.jsxs)("div",{className:"text-center",children:[(0,t.jsx)("div",{className:"text-lg font-bold text-omni-red",children:P.total}),(0,t.jsx)("div",{className:"text-[10px] text-muted-foreground",children:"إجمالي"})]}),(0,t.jsxs)("div",{className:"text-center",children:[(0,t.jsx)("div",{className:"text-lg font-bold text-green-600",children:P.completed}),(0,t.jsx)("div",{className:"text-[10px] text-muted-foreground",children:"مكتملة"})]}),(0,t.jsxs)("div",{className:"text-center",children:[(0,t.jsx)("div",{className:"text-lg font-bold text-omni-gold",children:P.inProgress}),(0,t.jsx)("div",{className:"text-[10px] text-muted-foreground",children:"قيد التقدم"})]}),(0,t.jsxs)("div",{className:"text-center",children:[(0,t.jsxs)("div",{className:"text-lg font-bold text-foreground",dir:"ltr",children:[Math.round(P.overallProgress),"%"]}),(0,t.jsx)("div",{className:"text-[10px] text-muted-foreground",children:"التقدم"})]})]}),(0,t.jsx)("div",{className:"mt-3 h-2 w-full rounded-full bg-muted overflow-hidden",children:(0,t.jsx)(s.motion.div,{className:"h-full rounded-full",style:{background:"linear-gradient(90deg, #B91C1C, #D4A843)"},initial:{width:0},animate:{width:`${Math.round(P.overallProgress)}%`},transition:{duration:1,ease:"easeOut"}})})]})})}),(0,t.jsx)(a.AnimatePresence,{children:A&&(0,t.jsx)(s.motion.div,{initial:{opacity:0,height:0},animate:{opacity:1,height:"auto"},exit:{opacity:0,height:0},transition:{duration:.3},className:"overflow-hidden",children:(0,t.jsxs)("div",{className:"rounded-xl border border-border p-4 space-y-3 bg-background/50",children:[(0,t.jsx)("h4",{className:"text-sm font-semibold text-omni-red",children:"محتويات التقرير"}),(0,t.jsx)("div",{className:"space-y-2",children:[{icon:(0,t.jsx)(d.FileText,{className:"size-3.5"}),text:"ه OmniSchool معلومات الطالب والعنوان",done:!0},{icon:(0,t.jsx)(c.BookOpen,{className:"size-3.5"}),text:`${P.total} مادة - ملخص التقدم العام`,done:!0},{icon:(0,t.jsx)(p.CheckCircle,{className:"size-3.5"}),text:`السداسي الأول: ${L.s1Completed} من ${E[1].length} مكتملة`,done:!0},{icon:(0,t.jsx)(g.Clock,{className:"size-3.5"}),text:`السداسي الثاني: ${L.s2Completed} من ${E[2].length} مكتملة`,done:!0},{icon:(0,t.jsx)(x.Circle,{className:"size-3.5"}),text:`${b.categories.length} تصنيفات مع نسب التقدم`,done:!0},{icon:(0,t.jsx)(m.GraduationCap,{className:"size-3.5"}),text:`معدل GPA: ${O.sem1.toFixed(2)} / ${O.sem2.toFixed(2)}`,done:!0},{icon:(0,t.jsx)(v.Flame,{className:"size-3.5"}),text:`سجل المواظبة: ${H.currentStreak} أيام متتالية`,done:!0}].map((e,i)=>(0,t.jsxs)("div",{className:"flex items-center gap-2 text-xs text-muted-foreground",children:[(0,t.jsx)("span",{className:"text-omni-red",children:e.icon}),e.text]},i))})]})})}),(0,t.jsxs)("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-3",children:[(0,t.jsx)(s.motion.div,{whileHover:{scale:1.02},whileTap:{scale:.98},children:(0,t.jsxs)(f.Button,{onClick:I,variant:"outline",className:"w-full gap-2 btn-ripple border-omni-gold/30 text-omni-gold-dark hover:bg-omni-gold/10 hover:text-omni-gold-dark dark:text-omni-gold dark:hover:bg-omni-gold/10",children:[(0,t.jsx)(o,{className:"size-4"}),"معاينة التقرير"]})}),(0,t.jsx)(s.motion.div,{whileHover:{scale:1.02},whileTap:{scale:.98},children:(0,t.jsx)(f.Button,{onClick:G,disabled:B,className:`w-full gap-2 btn-ripple ${S?"bg-green-600 hover:bg-green-700":"btn-omni-primary"}`,children:B?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(l.Loader2,{className:"size-4 animate-spin"}),"جارٍ الإنشاء..."]}):S?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.CheckCircle2,{className:"size-4"}),"تم الإنشاء ✓"]}):(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(r.Download,{className:"size-4"}),"تحميل PDF"]})})})]}),(0,t.jsx)("p",{className:"text-[11px] text-muted-foreground text-center",children:'سيتم فتح التقرير في نافذة جديدة. استخدم "حفظ كـ PDF" من متصفحك للتحميل.'})]})]})})}e.s(["ProgressReport",()=>N],68509)},25416,e=>{e.n(e.i(68509))}]);