...
const cardConfigs = [
  {
    ...
    accentBg: "linear-gradient(90deg, #8B7E6A, #A39480)",
    iconBg: "rgba(139, 126, 106, 0.1)",
    darkIconBg: "rgba(139, 126, 106, 0.12)",
    trendColor: "#8B7E6A",
  },
  {
    icon: CheckCircle2,
...
export function QuickStatsWidget() {
  ...
  const values = [stats.notStarted, stats.completed, stats.inProgress, stats.avgProgress];
  ...
  const sparklineData = useMemo(() => {
    ...
    return [
      [Math.ceil(stats.notStarted * 1.3), Math.ceil(stats.notStarted * 1.15), Math.ceil(stats.notStarted * 1.05), stats.notStarted],  // not started trend
